...
export const questData = [
   {
      ...
      description: "Cтолиця та найбільше місто <span className='translatWord'>України</span>. Розташований у середній течії Дніпра, у північній Наддніпрянщині. Політичний, соціально-економічний, транспортний, освітньо-науковий, історичний, <span className='translatWord'>культурний</span> та духовний центр України.",
      questionNum: '1/10',
